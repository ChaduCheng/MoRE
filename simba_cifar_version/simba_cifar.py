...
parser.add_argument('--idx', default=0, type=int, help='model num')
...
# transform_test = transforms.Compose([  # transforms.Resize(size=28),
#     transforms.ToTensor(),
...
## single clean expert
#loadname = '../cifar_clean_train_resnet/checkpoint/ckptnat_resnet18_cifar_tsave.pth'

#loadname = '../cifar_clean_train_resnet/checkpoint/ckptnat_resnet18_cifar_0.1_lu_l2_40*5_255.pth'


## all old
#loadname = '../cifar_16_resenet/checkpoint/ckptMoE_resnet_cifar_clean+4adv+4nat.pth'

## adv old

#loadname = '../cifar_16_resenet/checkpoint/ckptMoE_resnet_cifar_clean+4adv.pth'

## nat old

#loadname = '../cifar_16_resenet/checkpoint/ckptMoE_resnet_cifar_clean+4nat.pth'

## nat new

# loadname = '../cifar_16_resenet/checkpoint/ckptMoE_resnet_cifar_clean+4adv_true.pth'

## all new

loadname = '../cifar_16_resenet/checkpoint/ckptMoE_resnet_cifar_clean+4adv+4nat_true.pth'

#resnet18 = readmodel('moe', device)
...
def SimBA(testloader,
    ...
    with torch.no_grad():
        ...
        for inputs, targets in tqdm(testloader):
            ...
            for k in range(max_iters):
                ...
                print('attack success is:', 100. * success / float(total))
    ...
    print('quirese:', all_queries.mean())

    print('l2:', all_l2.mean())

    print('total:', total)

    print('final sucees is:', 100. * success / float(total))
...
SimBA(testloader,
      ...
      image_size=32)
#print('single model here')
#print('clean + 4 adv + 4 nat here')
#print('clean + 4 adv  here')
print('clean + 4 nat  here')