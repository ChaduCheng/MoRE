...
def train(args):
   ...
   #  model_loc3 = './trained_model/ckptl2_alex_cifar_50.pth'
    ...
    # model_loc1 = '../cifar_clean_train_resnet/checkpoint/ckpt_resnet18_cifar_linf_6_255.pth'
    # model_loc2 = '../cifar_clean_train_resnet/checkpoint/ckpt_resnet18_cifar_linf_8_255.pth'
    # model_loc3 = '../cifar_clean_train_resnet/checkpoint/ckpt_resnet18_cifar_l2_1_2.pth'
    # model_loc4 = '../cifar_clean_train_resnet/checkpoint/ckpt_resnet18_cifar_l2_255_255.pth'
    ...
    model_loc4 = '../cifar_clean_train_resnet/checkpoint/l2_1.0.pt'
   ...
   # #  print(model.state_dict().keys())
    ...
    for i in range(args.epochs):
        ...
        train_adv(train_loader, device, optimizer, model, model, AttackPGD, CE_loss, config_linf, attack,
                                 lr_schedule, i)

        train_adv(train_loader, device, optimizer, model, model, AttackPGD, CE_loss, config_l2, attack,
                               lr_schedule, i)
