...
def pgd_l2(model, X, y, epsilon=1.0, alpha=0.05, num_iter = 50, device = "cuda:0", restarts = 0, version = 0):
...
def pgd_l1_topk(model, X,y, epsilon = 8, alpha = 0.05, num_iter = 20, k = 20, device = "cuda:1", restarts = 1, version = 0):
# def pgd_l1_topk(model, X, y, epsilon=12, alpha=1.5, num_iter=20, k=20, device="cuda:1", restarts=1, version=0):
...
def pgd_linf(model, X, y, epsilon=8/255, alpha=0.003, num_iter = 40, device = "cuda:0", restarts = 0, version = 0):
...
def msd_v0(model, X,y, epsilon_l_inf = 8/255, epsilon_l_2= 1.0, epsilon_l_1 = 12,
