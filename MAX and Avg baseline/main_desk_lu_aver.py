...
from train_mod_lu_aver import train
...
def get_args():
    ...
    args.lr = 0.1
    args.gpu_ids = '0'
    #args.checkpoint_loc = './checkpoint/ckptnat_resnet18_cifar_ensemble_aver.pth'
    args.checkpoint_loc = './checkpoint/ckpt_resnet18_cifar_ensemble_aver_adv_at_change.pth'
