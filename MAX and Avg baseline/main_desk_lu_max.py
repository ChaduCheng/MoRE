...
def get_args():
    ...
    args.lr = 0.1
    args.gpu_ids = '0'
    #args.checkpoint_loc = './checkpoint/ckptnat_resnet18_cifar_ensemble_max.pth'
    args.checkpoint_loc = './checkpoint/ckptnat_resnet18_cifar_ensemble_max_adv_at_change.pth'
